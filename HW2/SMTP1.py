...
class smtp:  # define regex strings
    mail_from = "^MAIL( |\t)+FROM:.*$"
    rcpt_to = "^RCPT(\s|\t)+TO:.*$"
    path = "^( |\t)*<[^\s<>()[\]\.,;:@\"]+"\
